...
def render_stock_status_tab():
    render_html('<div class="section-head"><i class="fa-solid fa-clipboard-list"></i> Dynamic Stock Group Status</div>')
    st.caption("Exact representation of dynamic STOCK STATUS.xlsx synced from Tally & Excel stock sheets.")
    
    col_s1, col_s2 = st.columns(2)
    with col_s1:
        s_search = st.text_input("🔍 Filter Stock Sheet Item Code", key="stock_sheet_search")
    with col_s2:
